  ...
  <div class="MemberListingReward">
    ...
    >
      <template v-slot:content>
        <el-button type="warning">Download</el-button>
      </template>
    </form-inline-comp>
    <table-comp
    ...
    return {
      ...
      tableConfig: {
        ...
        tableColumn: [{
          ...
          prop: 'RedemptionItems',
          label: 'Redemption Items',
          width: '100'
        }, {
          prop: 'RedemptionPoints',
    ...
    initHttp (formInline) {
      ...
      for (var i = 0; i < 20; i++) {
        list.push({
          ...
          UpdatedDate: 'UpdatedDate' + i,
          Currency: 'Currency' + i,
          Category: 'Category' + i,
          OprationID: 'OprationID' + i,
          RedemptionID: 'RedemptionID' + i,
          Status: 'Status' + i
        })
      }
