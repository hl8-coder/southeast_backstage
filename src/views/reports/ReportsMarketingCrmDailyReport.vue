<template>
  <div class="ReportsMarketingCrmDailyReport">
    <form-inline-comp
...
import {
  backstageCrmReportDailyHttp,
  backstageCrmReportDropListHttp,
  backstageCrmReportDailyExportExcelHttp
} from '../../api/report/initAxios'
import filter from '../../util/filter'
export default {
  name: 'ReportsMarketingCrmDailyReport',
  ...
  methods: {
    ...
    initHttp (formInline) {
      ...
      backstageCrmReportDailyHttp(datalist).then(res => {
    ...
    exportExcel (formInline) {
      ...
      this.formInline = formInline
      var datalist = filter.formInlineFilter(formInline)
      backstageCrmReportDailyExportExcelHttp(datalist).then(res => {
